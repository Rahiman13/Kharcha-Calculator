...
const Home = () => {
  ...
  const addExpense = async (expense) => {
    try {
      const response = await axios.post('https://kharcha-calculator-backend.onrender.com/api/monthlydata/add-expense', { username, ...expense });
  ...
  const editExpense = async (expense) => {
    try {
      ...
      const response = await axios.put(`https://kharcha-calculator-backend.onrender.com/api/monthlydata/${username}/${month}/${_id}`, updatedData);
  ...
  const deleteExpense = async (month, expenseId) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          await axios.delete(`https://kharcha-calculator-backend.onrender.com/api/monthlydata/${username}/${month}/${expenseId}`);
